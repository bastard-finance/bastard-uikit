...
var shadows = {
    ...
    focus: "0px 0px 0px 1px #e76f51, 0px 0px 0px 4px #e76f51",
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/bastard-finance",
            },
            {
                label: "Docs",
                href: "https://bastard-finance.gitbook.io/bastard-finance/",
            },
            {
                label: "Blog",
                href: "https://bastard-finance.medium.com/",
            },
        ],
    },
];
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/bastardfinance",
            },
            {
                label: "Announcements",
                href: "https://t.me/bastardfinanceann",
            }
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/bastardfinance",
    }
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#264653", textDisabled: "#BDC2C4", textSubtle: "#366172", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#e9c46a", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#77bad4", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
